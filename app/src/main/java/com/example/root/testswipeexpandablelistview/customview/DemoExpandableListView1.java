 ...
 */
public class DemoExpandableListView1 extends BaseBaseSwipeExpandableListView
{
    // region Variables
    ...
    public DemoExpandableListView1(Context context)
    {
        super(context);
    ...
    public DemoExpandableListView1(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public DemoExpandableListView1(Context context, AttributeSet attrs, int defStyleAttr)
    {

 ...
 */
public class DemoListView2 extends BaseBaseSwipeListView
{
    // region Variables
    ...
    public DemoListView2(Context context)
    {
        super(context);
    ...
    public DemoListView2(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public DemoListView2(Context context, AttributeSet attrs, int defStyleAttr)
    {
